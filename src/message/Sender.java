...
public class Sender implements Runnable {
    ...
    String message = null;
    private String csca = ServerConstants.SMS_CENTER_NO; // the message center
    private SerialParameters defaultParameters = new SerialParameters( ServerConstants.COM_PORT_NO_SMS, 9600, 0, 0, 8, 1, 0);
    public int step;
    public int status = -1;
